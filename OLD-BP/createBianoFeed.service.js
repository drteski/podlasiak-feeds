...
const generateBianoFeed = async (lang) => {
	let products;
	let deliveryTime;
	switch (lang) {
		case 'de':
	...
	await csv.toDisk(`../generate/feed/biano_${lang}.csv`, { delimiter: ',' });
	console.log(`biano_${lang}.csv zapisany.`);
};

export default generateBianoFeed;
