...
const generateIdealoToolightFeed = async (lang) => {
	let products;
	let deliveryTime;
	switch (lang) {
		case 'de':
	...
	await csv.toDisk(`../generate/feed/idealo_toolight_${lang}.csv`, {
		delimiter: ',',
	});
	console.log(`idealo_toolight_${lang}.csv zapisany.`);
};

export default generateIdealoToolightFeed;
