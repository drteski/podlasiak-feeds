...
const generateBasicCsvMaciek = async (lang) => {
	let products;
	switch (lang) {
		case 'at':
	...
	await csv.toDisk(`../generate/feed/basic_${lang}_maciek.csv`, {
		delimiter: ';',
	});
	console.log(`basic_${lang}_maciek.csv zapisany.`);
};

export default generateBasicCsvMaciek;
