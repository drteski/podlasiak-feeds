...
const generateBianoToolightFeed = async (lang) => {
	let products;
	let deliveryTime;
	switch (lang) {
		case 'de':
	...
	await csv.toDisk(`../generate/feed/biano_toolight_${lang}.csv`, {
		delimiter: ',',
	});
	console.log(`biano_toolight_${lang}.csv zapisany.`);
};

export default generateBianoToolightFeed;
