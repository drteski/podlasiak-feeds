...
const feedBuilder = {
	...
	async feedBuliderJeftinjie(obj) {
		const root = builder
	...
	async generateFeedJeftinjie() {
		const data = await this.prepareData();
		const xmlJeftinjie = await feedBuilder.feedBuliderJeftinjie(data);
		await this.saveFileToDisk(xmlJeftinjie, 'jeftinije');
		console.log(`jeftinije.xml zapisany.`);
	},
};

const generateJeftinjie = async () => {
	try {
		await feedBuilder.generateFeedJeftinjie();
	} catch (e) {
		console.log(e);
	}
};

export default generateJeftinjie;
